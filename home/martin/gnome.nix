...

{
  ...
  dconf.settings = {
    ...
    "org/gnome/shell" = {
      ...
      favorite-apps = [ "thunderbird.desktop" "signal.desktop" "org.telegram.desktop" "firefox.desktop" "chromium.desktop" "org.gnome.Music.desktop" "org.gnome.Nautilus.desktop" "org.gnome.Console.desktop" "pycharm.desktop" "1password.desktop" "sublime_text.desktop" "zotero.desktop" "writer.desktop" ];
    };
