...

{
  ...
  dconf.settings = {
    ...
    "org/gnome/shell" = {
      ...
      favorite-apps = [ "thunderbird.desktop" "signal.desktop" "org.telegram.desktop" "firefox.desktop" "chromium-browser.desktop" "torbrowser.desktop" "org.gnome.Music.desktop" "org.gnome.Nautilus.desktop" "org.gnome.Console.desktop" "1password.desktop" "webstorm.desktop" "phpstorm.desktop" "pycharm.desktop" "sublime_text.desktop" "zotero.desktop" "calc.desktop" "writer.desktop" "gimp.desktop"];
    };
